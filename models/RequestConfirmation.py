...
class Re(models.Model):
    ...
    state = fields.Selection([('ongoing', 'Pending Manager'),('reject_one','Rejected'),('confirmed_one', 'Pending Accountant To'),('confirmed_two', 'Pending Manager To'),('confirmed_three', 'Confirmed')],default="ongoing", string="Status")
