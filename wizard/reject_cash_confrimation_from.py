...
class CashReject(models.TransientModel):
    _name = "cash_managment.reject_cash_confirmation_from"
    ...
    @api.multi
    def reject_cash_confirmation(self):
        ...
        cashs = self.env['cash_managment.requestapproved'].browse(self._context.get('active_ids'))
        for reqs in cashs:
